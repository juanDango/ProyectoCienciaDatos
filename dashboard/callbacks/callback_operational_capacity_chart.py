...
def update_operationalcapacity_chart_logic(clusters, industries, revenue_trend, employees, liquidity, s_debt, l_debt, t_revenue):
    ...
    return OperationalCapacityChart(
        data=filtered_data,
    ).render()
